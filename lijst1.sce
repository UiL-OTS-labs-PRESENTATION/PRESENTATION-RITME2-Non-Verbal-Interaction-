...
# array voor plaatjes tijdens de start van de dialoog
	array {
		...
		picture {description = "inactive_start1"; bitmap { filename = "inactive_start1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} inactive_start2;
...
# array voor plaatjes tijdens de eerste dialoog
	array {
		...
		picture {description = "active_first1" ; bitmap { filename = "active_first1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} active_first2;
...
# array voor plaatjes tijdens de eerste dialoog
	array {
		...
		picture {description = "inactive_first1" ; bitmap { filename = "inactive_first1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} inactive_first2;
...
# array voor plaatjes tijdens de tweede dialoog
	array {
		...
		picture {description = "active_second1" ; bitmap { filename = "active_second1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} active_second2;
...
# array voor plaatjes tijdens de tweede dialoog
	array {
		...
		picture {description = "inactive_second1" ; bitmap { filename = "inactive_second1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} inactive_second2;
...
# array voor plaatjes tijdens de tweede dialoog
	array {
		...
		picture {description = "active_third1" ; bitmap { filename = "active_third1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} active_third2;
	...
	array {
		...
		picture {description = "inactive_end1" ; bitmap { filename = "inactive_end1_shrunk.png";  scale_factor = 0.3; preload = true; }; x=0; y=0;} inactive_end2;
...
#trial active first display
	...
	array {
		...
		picture { bitmap { filename = "foto2.jpg"; preload = true; description = "pauze2" ;}; x=0; y=0;} pic2;
		picture { bitmap { filename = "foto3.jpg"; preload = true; description = "pauze3" ;}; x=0; y=0;} pic3;
		picture { bitmap { filename = "foto4.jpg"; preload = true; description = "pauze4" ;}; x=0; y=0;} pic4;
		picture { bitmap { filename = "foto5.jpg"; preload = true; description = "pauze5" ;}; x=0; y=0;} pic5;
		picture { bitmap { filename = "foto6.jpg"; preload = true; description = "pauze6" ;}; x=0; y=0;} pic6;
	} pauzes;
